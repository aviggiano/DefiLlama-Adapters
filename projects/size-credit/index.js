...
const config = {
  base: {
    WETH_USDC: {
      ...
      UnderlyingBorrowToken: ADDRESSES.base.USDbC,
...
Object.keys(config).forEach(chain => {
  module.exports[chain] = {
    tvl: sumTokensExport({ tokens: [config[chain].UnderlyingCollateralToken, config[chain].UnderlyingBorrowAToken], owner: config[chain].Size }),
    borrowed: (api) => getBorrowed(api, config[chain].BorrowAToken)
  }
})
